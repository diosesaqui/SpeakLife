...
public final class FavoritesMigrationService {
    ...
    public func migrateLegacyFavorites() async throws {
    ...
    private func logMigrationResults(_ results: MigrationResults) {
        ...
        CoreAnalytics.track("favorites_migration_completed", parameters: [
...
public struct MigrationResults {
    public var audioFavoritesMigrated = 0
    public var audioFavoritesSkipped = 0
    public var audioFavoritesFailed = 0

    public var declarationFavoritesMigrated = 0
    public var declarationFavoritesSkipped = 0
    public var declarationFavoritesFailed = 0
