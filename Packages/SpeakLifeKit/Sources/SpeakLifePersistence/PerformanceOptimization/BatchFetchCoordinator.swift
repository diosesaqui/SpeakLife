...
public final class BatchFetchCoordinator {

    public static let shared = BatchFetchCoordinator()
    ...
    public func fetchAllFavoritesOptimized() async -> (declarations: [Declaration], audio: [AudioDeclaration]) {
    ...
    public func fetchMyOwnContentOptimized() async -> [Declaration] {
        await withCheckedContinuation { continuation in
            context.perform { [context] in
                var declarations: [Declaration] = []
