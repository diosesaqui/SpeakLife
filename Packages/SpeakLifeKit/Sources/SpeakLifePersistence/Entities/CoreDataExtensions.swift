...
extension Declaration {
    ...
    public init(from journalEntry: JournalEntry) {
        self.init(
    ...
    public init(from affirmationEntry: AffirmationEntry) {
        self.init(
...
extension JournalEntry {
    ...
    public convenience init(from declaration: Declaration, context: NSManagedObjectContext) {
    ...
    public func updateFrom(declaration: Declaration) {
        self.text = declaration.text
        self.book = declaration.book
        self.bibleVerseText = declaration.bibleVerseText
        self.category = declaration.category.rawValue
...
extension Array where Element == JournalEntry {
    ...
    public func toDeclarations() -> [Declaration] {
...
extension Array where Element == Declaration {
    ...
    public func toJournalEntries(context: NSManagedObjectContext) -> [JournalEntry] {
    ...
    public func toAffirmationEntries(context: NSManagedObjectContext) -> [AffirmationEntry] {
        return self.compactMap { declaration in
