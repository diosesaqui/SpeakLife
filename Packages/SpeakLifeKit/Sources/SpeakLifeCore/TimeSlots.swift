...
//  SpeakLifeCore
//
//  Foundation-only helper used by NotificationManager to lay out the 30-minute
//  slots that daily-notification times are picked from.
//
...
public final class TimeSlots {
    ...
    public static func getTimeSlots() -> [String] {
    ...
    public static func getDateTimeSlots() -> [Date] {
        var timeSlots = [Double]()
        let firstTime: Double = 0.0
        let lastTime: Double = 24
        let slotIncrement = 0.5
