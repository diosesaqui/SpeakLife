...
//  SpeakLife
//
//  Central personalization engine powered by survey responses.
//  Consumes AppState.surveyGoalWord and produces copy for:
//    - Paywall (headline, subheadline, value props, CTA, urgency)
//    - Notification onboarding (headline, subheadline, CTA)
//    - (Future) Audio recommendations, devotional routing
//
//  Usage:
//    let engine = SurveyPersonalizationEngine(goalWordRaw: appState.surveyGoalWord)
//    let copy = engine.paywallCopy
//    let notifCopy = engine.notificationCopy
//
...
struct SurveyPersonalizationEngine {
    ...
    /// Initialize with raw stored string from AppState.surveyGoalWord
    init(goalWordRaw: String) {
        self.goalWord = SurveyGoalWord(rawValue: goalWordRaw)
    }

    /// Init directly with typed enum (for previews / testing)
    ...
    var paywallCopy: SurveyPaywallCopy {
        guard let word = goalWord else {
            return defaultPaywallCopy
        }
        switch word {
        case .peace:
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        icon: "wind",
                        title: "Declarations for Peace",
                        description: "Targeted scripture over anxiety, fear, and worry — spoken out loud, daily."
                    ),
                    SurveyValueProp(
                        icon: "moon.stars.fill",
                        title: "Night-Mode Declarations",
                        description: "Quiet your mind before bed with promises that stop anxious thoughts cold."
                    ),
                    SurveyValueProp(
                        icon: "brain.head.profile",
                        title: "Mind Renewal Track",
                        description: "A 21-day plan to replace fear-thinking with Kingdom-thinking."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Praying",
                        description: "You are not fighting this alone. Never were."
                    )
                ],
            ...
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        ...
                        description: "Scripture that dismantles 'I'm not enough' and replaces it with who God says you are."
                    ),
                    SurveyValueProp(
                        icon: "book.fill",
                        title: "Identity Devotionals",
                        description: "Daily readings that anchor your worth in God, not performance."
                    ),
                    SurveyValueProp(
                        icon: "repeat.circle.fill",
                        title: "21-Day Identity Reset",
                        description: "A guided journey from self-doubt to unshakeable God-confidence."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Standing With You",
                        description: "A community declaring truth over each other every single day."
                    )
                ],
        ...
        case .purpose:
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        icon: "flame.fill",
                        title: "Purpose Declarations",
                        description: "Speak boldness, clarity, and calling into existence every morning."
                    ),
                    SurveyValueProp(
                        icon: "map.fill",
                        title: "Destiny Devotionals",
                        description: "Daily word for those who feel they were made for more — because you were."
                    ),
                    SurveyValueProp(
                        icon: "arrow.up.forward.circle.fill",
                        title: "Purpose Activation Track",
                        description: "A 21-day plan for those stepping into their God-given assignment."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Pursuing Their Calling",
                        description: "A community of people who refused to stay small."
                    )
                ],
        ...
        case .joy:
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        icon: "sun.max.fill",
                        title: "Joy Declarations",
                        description: "Scripture that restores gladness when life has drained it from you."
                    ),
                    SurveyValueProp(
                        icon: "music.note",
                        title: "Joy Audio Devotionals",
                        description: "Start your day with praise that shifts your atmosphere in minutes."
                    ),
                    SurveyValueProp(
                        icon: "arrow.counterclockwise.circle.fill",
                        title: "21-Day Joy Restoration",
                        description: "A guided plan to reignite what grief, stress, or burnout took from you."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Choosing Joy Daily",
                        description: "Proof that it's possible — and that you won't be doing it alone."
                    )
                ],
        ...
        case .confidence:
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        icon: "bolt.fill",
                        title: "Confidence Declarations",
                        description: "Speak boldness into your DNA — daily, out loud, until it sticks."
                    ),
                    SurveyValueProp(
                        icon: "crown.fill",
                        title: "Identity in Christ Track",
                        description: "Know your position so thoroughly that doubt can't find a foothold."
                    ),
                    SurveyValueProp(
                        icon: "figure.stand",
                        title: "Bold Living Devotionals",
                        description: "Daily readings for those stepping into rooms they almost talked themselves out of."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Walking in Authority",
                        description: "A community of people who decided to stop living small."
                    )
                ],
            ...
            return SurveyPaywallCopy(
                ...
                valueProps: [
                    SurveyValueProp(
                        ...
                        description: "God's promises over your body, mind, and soul — spoken aloud every day."
                    ),
                    SurveyValueProp(
                        icon: "heart.fill",
                        title: "Restoration Devotionals",
                        description: "Daily word for those walking through grief, loss, sickness, or broken seasons."
                    ),
                    SurveyValueProp(
                        icon: "waveform.path.ecg",
                        title: "Healing Scriptures Track",
                        description: "A 21-day journey through God's promises for wholeness."
                    ),
                    SurveyValueProp(
                        icon: "person.2.fill",
                        title: "100,000+ Believers Standing in Faith",
                        description: "A community praying for healing and breakthrough — together."
                    )
                ],
    ...
    var notificationCopy: SurveyNotificationCopy {
        guard let word = goalWord else {
            return defaultNotificationCopy
        }
