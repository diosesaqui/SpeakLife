    ...
    private func sheetContent(_ sheet: ActiveSheet) -> some View {
        ...
        case .dailyChecklist:
            ModernDailyChecklistView(viewModel: streakViewModel)
                .environmentObject(streakViewModel)
                // audioDeclarationViewModel and tabViewModel are already in the
                // environment chain (injected at root in SpeakLifeApp).
                // ModernDailyChecklistView declares @EnvironmentObject for both.
        case .timerStreak:
