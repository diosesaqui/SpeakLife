...
struct FeaturesSection: View {
    let features = [
        BootcampFeature(icon: "book.fill", title: "Biblical Foundation", description: "Deep dive into God's Word with practical application"),
        BootcampFeature(icon: "person.3.fill", title: "Community Support", description: "Connect with fellow warriors on the same journey"),
        BootcampFeature(icon: "video.fill", title: "Live Sessions", description: "Weekly live Q&A and prayer sessions"),
        BootcampFeature(icon: "medal.fill", title: "Certifications", description: "Earn certificates of completion and excellence")
    ]
        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            LazyVGrid(columns: [GridItem(.flexible()), GridItem(.flexible())], spacing: 16) {
                ForEach(features, id: \.title) { feature in
                    BootcampFeatureCard(feature: feature)
                }
            }
            .padding(.horizontal)
        }
...
struct BootcampFeature {
    let icon: String
    let title: String
    let description: String
}

struct BootcampFeatureCard: View {
    let feature: BootcampFeature
