...
enum DebugFlagCatalog {
    ...
    static let boolFlags: [Flag] = [
        ...
        Flag(key: "standTogetherEnabled",
             title: "Stand With Me",
             blurb: "Off hides every Stand surface. The user's own campaign keeps running — the room was only ever a mirror of it."),
        ...
        Flag(key: "stormBenefitScreen",
             title: "Storm onboarding: benefit screen",
             blurb: "Off skips screen 6b (the three storm promises)."),
        Flag(key: "stormTrialPushes",
             title: "Storm trial-week pushes",
             blurb: "Off stops the Day 1 audio and Day 2 Bible chat pushes."),
        Flag(key: "stormAlsoIncluded",
             title: "Storm paywall: Also included",
             blurb: "On adds the audio + Bible chat row under the storm paywall's benefits."),
