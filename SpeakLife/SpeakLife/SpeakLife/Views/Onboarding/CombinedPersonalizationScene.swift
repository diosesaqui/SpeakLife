                    ...
                    ScrollView(showsIndicators: false) {
                        VStack(spacing: proxy.size.height < 700 ? 15 : 25) {
                            ...
                            VStack(spacing: proxy.size.height < 700 ? 10 : 15) {
                                Text("What Are You Believing God For?")
...
extension DeclarationCategory {
    ...
    var displayName: String {
        switch self {
        case .anxiety: return "Worry → Peace"
        case .fear: return "Fear → Freedom"
        case .faith: return "Doubt → Bold Faith"
        case .health: return "Sickness → Healing"
        case .marriage: return "Conflict → Breakthrough"
        case .joy: return "Sadness → Joy"
        case .rest: return "Burnout → Rest"
        case .confidence: return "Shame → Confidence"
        case .hope: return "Hopeless → Hopeful"
        case .wealth: return "Lack → Provision"
        case .wisdom: return "Confusion → Wisdom"
        case .grace: return "Striving → Grace"
        case .addiction: return "Bondage → Freedom"
        case .godsprotection: return "Exposed → Protected"
        case .hardtimes: return "Hard Times → Strength"
        case .parenting: return "Lost → Leading Well"
        case .identity: return "Lost → Identity in Christ"
        case .general: return "General"
        case .praise: return "Praise & Worship"
        case .love: return "Love"
        case .gratitude: return "Gratitude"
        case .warfare: return "Attacked → Victorious"
        case .miracles: return "Stuck → Miracles"
        case .favor: return "Overlooked → Favored"
        case .work: return "Stuck → Purpose & Success"
        case .friendship: return "Isolated → Connected"
        case .innerHealing: return "Broken → Whole"
        case .spiritualGrowth: return "Stagnant → Growing"
