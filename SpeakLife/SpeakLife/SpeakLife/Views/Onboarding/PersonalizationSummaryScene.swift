                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: proxy.size.height < 700 ? 20 : 30) {
                        ...
                        VStack(spacing: proxy.size.height < 700 ? 12 : 16) {
                            Text("Your 7-Day Faith Reset Starts Now")
                            ...
                            Text("In 7 days, you'll begin to shift from:")
                        ...
                        VStack(spacing: proxy.size.height < 700 ? 16 : 20) {
                            ...
                            Text("Your 7-Day Reset includes:")
                            ...
                            VStack(spacing: proxy.size.height < 700 ? 10 : 12) {
                                OnboardingFeatureRow(
                                    ...
                                    text: "Declarations tailored to your struggles",
                                ...
                                OnboardingFeatureRow(
                                    icon: "checkmark.circle.fill",
                                    text: "Scripture-backed breakthrough prayers",
                                    isCompact: proxy.size.height < 700
                                )
                                
                                OnboardingFeatureRow(
                                    icon: "checkmark.circle.fill",
                                    text: "Daily streak to track your faith growth",
                                    isCompact: proxy.size.height < 700
                                )
