...
struct OptimizedSubscriptionViewV2: View {
    ...
    private var heroSection: some View {
        VStack(spacing: 12) {
            Text("SpeakLife rewires how you see yourself - one declaration at a time.")
                .font(.system(size: 24, weight: .bold))
                .foregroundColor(.white)
                .multilineTextAlignment(.center)

            Text("From anxiety to peace. From shame to identity. From fear to bold faith.")
    ...
    private var valuePropsSection: some View {
        VStack(spacing: 20) {
            ValuePropRow(
                ...
                title: "Personalized to Your Journey",
                description: "Declarations matched to what you're believing God for - from day one."
            )

            ValuePropRow(
                icon: "shield.lefthalf.filled",
                title: "Scripture-Backed Declarations",
                description: "Know exactly what to declare in every season of life."
            )

            ValuePropRow(
                icon: "flame.fill",
                title: "Streak & Faith Growth Tracking",
                description: "See your transformation in real time - days declared, ground taken."
            )

            ValuePropRow(
                icon: "chart.line.uptrend.xyaxis",
                title: "Daily Guided Audio Devotionals",
                description: "Start every day with truth. Watch anxiety shrink and boldness grow."
            )

            ValuePropRow(
                icon: "shield.fill",
                title: "30-Day Satisfaction Guarantee",
                description: "Feel a shift in 30 days or get a full refund. No questions asked."
            )
        }
    }
    ...
    private var socialProofSection: some View {
        VStack(spacing: 12) {
            Text("Join 100,000+ believers who've made the shift")
            ...
            // Testimonial 1
            VStack(spacing: 8) {
                Text("\"I used to wake up anxious every single morning. Now I wake up declaring. SpeakLife changed everything.\"")
            ...
            // Testimonial 2
            VStack(spacing: 8) {
                Text("\"I didn't know who I was in Christ. After 30 days of declarations, I feel like a different person.\"")
                    .font(.system(size: 13, weight: .regular))
                    .foregroundColor(.white.opacity(0.8))
                    .italic()
                    .multilineTextAlignment(.center)
    ...
    private var stickyBottomSection: some View {
        VStack(spacing: 16) {
                ...
                HStack {
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        HStack(spacing: 6) {
                            ...
                            Text("just $4.17/mo billed annually")
            ...
            Text("Start your 7-Day Faith Reset FREE")
                .font(.system(size: 14, weight: .medium))
                .foregroundColor(.white.opacity(0.9))
                .multilineTextAlignment(.center)
            ...
            HStack(spacing: 6) {
                ...
                Text("30-day money-back guarantee. Feel the shift or get a full refund.")
                    .font(.system(size: 12))
