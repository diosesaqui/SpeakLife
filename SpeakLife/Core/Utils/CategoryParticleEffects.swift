...
final class CategoryThemeManager: ObservableObject {
    ...
    enum CategoryTheme: String, CaseIterable {
        ...
        var colors: [Color] {
            ...
            case .hope:
                return [.yellow, .orange, Constants.gold]
            case .love:
            ...
            case .confidence:
                return [.orange, .yellow, Constants.gold]
            case .destiny:
                return [.purple, Constants.gold, .white]
            case .identity:
                return [.blue, .teal, .white]
            case .marriage:
                return [.red, .pink, Constants.gold]
            case .parenting:
            ...
            case .wealth:
                return [Constants.gold, .yellow, .green]
            case .favor:
                return [.purple, Constants.gold, .white]
            case .miracles:
                return [.white, Constants.gold, .blue]
            case .warfare:
                return [.red, .orange, Constants.gold]
            case .protection:
                return [.blue, .white, .gray]
            case .purity:
