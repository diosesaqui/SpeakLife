...
struct ParticleSystem: View {
    ...
    enum ParticleType {
        ...
        var colors: [Color] {
            ...
            case .stars: return [.yellow, Constants.gold, .orange]
            case .fireworks: return [.red, .blue, .green, .yellow, .purple, .orange]
            case .golden: return [.yellow, Constants.gold, .orange, .white]
            case .celebration: return [.red, .pink, .purple, .blue, .green, .yellow]
            case .premium: return [.purple, Constants.gold, .white, .blue]
